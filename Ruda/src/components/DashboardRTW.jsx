          ...
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} md={1.5}>
              <Paper sx={{ boxShadow: 'none', p: 2, textAlign: 'center' }}>
                ...
                <Typography fontWeight="bold" fontSize="1.2rem">PKR {data.awarded_cost}M</Typography>
              </Paper>
            </Grid>
            ...
            <Grid item xs={12} md={1.5}>
              <Paper sx={{ boxShadow: 'none', p: 2, textAlign: 'center' }}>
                ...
                <Typography fontWeight="bold" fontSize="1.2rem">{data.duration_months} Months</Typography>
              </Paper>
            </Grid>
          </Grid>
